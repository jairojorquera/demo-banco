...
public class UsuarioService {
    ...
    public Resultado<UsuarioPublico> saveUsuario(Usuario usuario) {
        ...
        UsuarioPublico usuarioRegistrado = usuarioRepositorio.save(usuario);

        return Resultado.of(usuarioRegistrado);
    }

    public Resultado<UsuarioPublico> getUsuario(String rut) {
